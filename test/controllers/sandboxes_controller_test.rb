...
class SandboxesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sandbox" do
    assert_difference('Sandbox.count') do
      post sandboxes_url, params: { sandbox: { email: @sandbox.email, mensagem: @sandbox.mensagem, nome: @sandbox.nome } }
    end
  ...
  test "should update sandbox" do
    patch sandbox_url(@sandbox), params: { sandbox: { email: @sandbox.email, mensagem: @sandbox.mensagem, nome: @sandbox.nome } }
