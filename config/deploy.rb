...
set :application_name, 'sotreq'
set :domain, '142.93.63.58'
set :deploy_to, '/var/www/sotreq'
set :repository, 'https://github.com/kentarofujiy/sotreq-landingpage.git'
set :user, 'appuser'
set :branch, 'master'
set :term_mode, nil
...
task :remote_environment do
  ...
  # invoke :'rvm:use', 'ruby-2.5.0@sotreq'
end
